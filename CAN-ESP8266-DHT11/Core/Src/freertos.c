...
void MX_FREERTOS_Init(void) {
  ...
  OLEDQueueHandle = osMessageQueueNew (5, sizeof(DHT11_Data_t), &OLEDQueue_attributes);

  /* creation of WiFiQueue */
  WiFiQueueHandle = osMessageQueueNew (5, sizeof(DHT11_Data_t), &WiFiQueue_attributes);
  ...
  WiFiTaskHandle = osThreadNew(WiFiStartTask, NULL, &WiFiTask_attributes);
